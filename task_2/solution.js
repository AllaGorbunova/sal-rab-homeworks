function calcShipping(sum, min, shipping) {
    ...
    if (shippingSum = 0) // если productsSum равно 0,
    {
        shippingSum = 0;
...
function calcInvoice({sum, discountMinSum, discountPart, shippingFreeMinSum, shippingPrice}) {
    ...
    freeShipping = true;
    shippingSum != 0
    freeShipping = false;;// если shippingSum равно нулю, то freeShipping должна быть равна true, иначе freeShipping должна быть равна false
